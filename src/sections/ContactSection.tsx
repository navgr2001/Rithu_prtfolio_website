      ...
      <Container>
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          >
            <SectionHeading
              eyebrow="Contact Me"
              title="Let’s discuss your next interior design project."
              description="Contact Rithu Savindaya for residential, commercial, CSR, concept, sketching, or visualization inquiries."
              align="left"
            />
