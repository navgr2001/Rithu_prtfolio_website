...
const PROJECT_MAIN_TABS = ["Residential", "Commercial", "Technical"] as const;
  ...
  Residential: [
    {
      category: "Apartments",
      projectNames: [
        "galaxy iconic apartment",
        "kollupitiya apartment",
        "prime apartment",
      ],
    },
    {
      category: "Villas",
      projectNames: ["canterbury project", "santorini villa"],
    },
  ],
  Commercial: [
    {
      category: "CSR & Children",
      projectNames: ["apeksha hospital", "csr project"],
    },
    {
      category: "Hospitality",
      projectNames: ["bakery project"],
    },
  ],
  Technical: [
    {
      category: "Hand Sketches",
      projectNames: ["hand sketch", "handsketch"],
    },
    {
      category: "Furniture Details",
      projectNames: ["furniture details", "funituer details", "funiture details"],
    },
  ],
};
...
export function ProjectsSection() {
  const [activeMainTab, setActiveMainTab] =
    useState<ProjectMainTab>("Residential");
  const [activeCategory, setActiveCategory] =
    useState<StructuredProjectCategory>(PROJECT_STRUCTURE.Residential[0].category);
    ...
    <section id="projects" className="py-20 sm:py-28">
      <Container>
        <SectionHeading
          ...
          title="Interior design work presented with calm luxury, clarity, and warmth."
          description="Browse residential, commercial, CSR, hand sketch, and furniture detail projects taken from the portfolio presentation. Each project supports a focused preview and an expandable gallery."
        />
          ...
          <div className="glass-panel project-browser-panel overflow-hidden p-4 sm:p-5 lg:p-6">
            <div className="project-browser-top">
              ...
              <div className="project-browser-search">
                <input
                  ...
                  placeholder="Search by title, category, timeline..."
            ...
            <div className="project-filter-groups">
              <div className="project-filter-group">
                <p className="project-filter-label">Portfolio Area</p>
          ...
          {selectedProject ? (
                  ...
                  <div className="p-6 sm:p-8 lg:p-10">
                    <div className="project-feature-details-layout">
                      ...
                      <div className="project-feature-stats mt-8 grid gap-4 sm:grid-cols-3">
                        ...
                        <div className="project-stat-card">
                          <p className="project-stat-label">Timeline</p>
                          <p className="project-stat-value">
            ...
            <div className="glass-panel p-8 text-center sm:p-12">
              ...
              <h3 className="mt-4 text-2xl font-medium text-white">
                Try another portfolio area, category, or keyword
              </h3>
